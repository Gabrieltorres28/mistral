    ...
    <main className="bg-background">
        ...
        <div className="section-shell relative grid gap-8 py-10 sm:py-14 lg:grid-cols-[1fr_360px] lg:items-end lg:py-16">
          ...
          <header>
            ...
            <p className="mt-5 max-w-3xl text-base leading-8 text-white/74">
              Empresa de servicios técnicos con base operativa en Wanda, Misiones, orientada a mantenimiento, montajes,
          ...
          <aside className="rounded-xl border border-white/12 bg-white/8 p-5 shadow-[0_24px_70px_rgba(0,0,0,0.22)] backdrop-blur-sm">
            ...
            <div className="mt-5 rounded-lg border border-white/10 bg-white/[0.04] p-4">
              ...
              <p className="mt-3 text-sm font-semibold text-white">Perfil técnico y operativo</p>
              <p className="mt-2 text-sm leading-6 text-white/62">
                Coordinación de recursos, movilidad y tareas técnicas para servicios programados y asistencia en campo.
              </p>
            </div>
          </aside>
          </Reveal>
      ...
      <section className="section-shell grid gap-8 py-12 lg:grid-cols-[1fr_0.75fr] lg:py-16">
        ...
        <article className="rounded-xl border border-border bg-white p-6 shadow-[0_16px_38px_rgba(31,31,31,0.05)]">
          ...
          <h2 className="mt-3 text-2xl font-semibold text-graphite">Servicios técnicos para operación y mantenimiento</h2>
          <p className="mt-4 text-sm leading-7 text-muted-foreground">
            La actividad se organiza alrededor de mantenimiento, montajes, limpieza industrial y soporte para espacios gastronómicos, con coordinación de recursos, movilidad y tareas técnicas.
          </p>
          <div className="mt-6">
      ...
      <section id="capacidad-operativa" className="section-band scroll-mt-28 py-12 lg:py-16">
        <div className="section-shell">
          <Reveal className="industrial-panel p-6 sm:p-8" y={18}>
            <p className="section-kicker">Capacidad operativa</p>
            <h2 className="section-title mt-3">Móviles, herramientas y logística de trabajo</h2>
            <p className="section-copy mt-4">
              La versión completa de capacidad operativa se encuentra en una ruta dedicada para mantener la navegación clara.
            </p>
            <div className="mt-6">
